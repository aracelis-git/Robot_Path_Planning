...
void displayHelp(){
  ...
  cout << "Env types: taxi tworooms fourrooms energy fuelworld mcar cartpole car2to7 car7to2 carrandom "
		  "       stocks lightworld corridor\n";
  cout << "\n Options:\n";
...
void initEnvironment(){
  ...
  // corridor
    else if (strcmp(envType, "corridor") == 0){
      desc.title = "Environment: Corridor\n";
      e = new Corridor(rng, true);
    }
